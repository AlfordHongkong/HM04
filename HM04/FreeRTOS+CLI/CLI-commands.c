...
/*
 * implement the set fault command command.
 */
//static portBASE_TYPE prvSetFaultFlagCommand(int8_t *pcWriteBuffer, size_t xWriteBufferLen, const int8_t *pcCommandString);

/*
 * implement the change fan pwm command.
 */
//static portBASE_TYPE prvChangeFanPwmCommand(int8_t *pcWriteBuffer, size_t xWriteBufferLen, const int8_t *pcCommandString);
...
// static const CLI_Command_Definition_t prvSetFaultFlagCommandDefinition =
// {
// 	( const int8_t * const ) "set-fault",
// 	( const int8_t * const ) "set-fault <param>:\r\n 1 == enable; 0 == disable. \r\n\r\n",
// 	prvSetFaultFlagCommand, /* The function to run. */
// 	1 /* A single parameter should be entered. */
// };

// static const CLI_Command_Definition_t prvChangeFanPwmCommandDefinition = 
// {
// 	( const int8_t * const ) "change-fan-pwm",
// 	( const int8_t * const ) "change-fan-pwm <param>:\r\n paramter range: 1-100. \r\n\r\n",
// 	prvChangeFanPwmCommand,
// 	1
// };
...
void vRegisterCLICommands( void )
{
	...
	//FreeRTOS_CLIRegisterCommand( &prvSetFaultFlagCommandDefinition);
	//FreeRTOS_CLIRegisterCommand( &prvChangeFanPwmCommandDefinition);
}
/*-----------------------------------------------------------*/
...
static portBASE_TYPE xParameterNumber = 0;
	...
	else
	{
		...
		sprintf( ( char * ) pcWriteBuffer, "%d: ", (int)(xParameterNumber) );
...
// 		/* Return the parameter string. */
// 		if (*pcParameterString == '1')
// 		{
// 			//printf("Enabel fault.");
// 			sprintf( ( char * ) pcWriteBuffer, "Enabel fault.\r\n");
// 			SetFaultEnableFlag2EEPROM(TRUE);
// 			HAL_NVIC_SystemReset();
// 		}
// 		else if (*pcParameterString == '0') 
// 		{
// 			sprintf( ( char * ) pcWriteBuffer, "Disable fault.\r\n");
// 			SetFaultEnableFlag2EEPROM(FALSE);
// 			HAL_NVIC_SystemReset();
// 		}
// 		else {
// 			sprintf( ( char * ) pcWriteBuffer, "Parameter shoud be 1 or 0.\r\n");
...
// 		uint8_t len = strlen(pcParameterString);
// 		uint8_t parameterInteger=0;
// 		for (uint8_t i = 0; i<len; i++){
// 			parameterInteger = (parameterInteger*10 + (*pcParameterString++ - '0'));
// 		}

// 		/* Return the parameter string. */
// 		if ((parameterInteger > 100) || (parameterInteger < 0) )
// 		{
// 			//printf("Enabel fault.");
// 			sprintf( ( char * ) pcWriteBuffer, "Input parameter should be 0-100.\r\n");
			
// 		}
// 		else {
// 			/* revock fan pwm change func */

// 			SetFanPWM(parameterInteger);
// 			sprintf( ( char * ) pcWriteBuffer, "Change fan pwm to %s.\r\n", *pcParameterString);
