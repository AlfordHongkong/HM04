...
//	}
	...
	{
	HAL_UART_Transmit(&UART4CLI, (uint8_t *) pcWelcomeMessage, strlen( ( char * ) pcWelcomeMessage ) ,strlen( ( char * ) pcWelcomeMessage ) );
	...
	for( ;; )
	{
		...
		/* the code below included in the for is the implement of command line interface.   */
...
//			}
			//if(UART_CheckIdleState(&UART4CLI) == HAL_OK)
			{
			HAL_UART_Transmit(&UART4CLI, (uint8_t *) pcNewLine, strlen( ( char * ) pcNewLine ), strlen( ( char * ) pcNewLine ) );
...
//					FreeRTOS_write( xConsoleUART, pcOutputString, strlen( ( char * ) pcOutputString ) );
          			HAL_UART_Transmit(&UART4CLI, (uint8_t *) pcOutputString, strlen( ( char * ) pcOutputString ), strlen( ( char * ) pcOutputString ) );
				}
...
//			}
			//if(UART_CheckIdleState(&UART4CLI) == HAL_OK)
			{
			HAL_UART_Transmit(&UART4CLI, (uint8_t *) pcEndOfCommandOutputString, strlen( ( char * ) pcEndOfCommandOutputString ), strlen( ( char * ) pcEndOfCommandOutputString ) );
...
//	}
    ...
    //if(UART_CheckIdleState(&UART4CLI) == HAL_OK)
    {
      HAL_UART_Transmit(&UART4CLI, (uint8_t *) pucMessage, strlen( ( char * ) pucMessage ), strlen( ( char * ) pucMessage ) );
